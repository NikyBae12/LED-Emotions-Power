...
public class Comprobante {
    ...
    public Comprobante(Integer id_comprob, String id_usuario, Date fecha_Autu, int factura, int valor, Usuario usuario_rel) {
    ...
    public Integer getId_comprob() {
        return Id_comprob;
    }

    public void setId_comprob(Integer id_comprob) {
