...
public class Sesion_Emo {
    ...
    private Integer Id_Sesion_Emocional;
    ...
    public Sesion_Emo(Integer id_Sesion_Emocional, SesionTerapia id_Sesion_rel, Emociones id_Emocion) {
    ...
    public Integer getId_Sesion_Emocional() {
        return Id_Sesion_Emocional;
    }

    public void setId_Sesion_Emocional(Integer id_Sesion_Emocional) {
        Id_Sesion_Emocional = id_Sesion_Emocional;
    }
